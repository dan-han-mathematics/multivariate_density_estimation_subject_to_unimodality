...
png(file = "boxplot_rmise_gaussian.png", bg = "transparent",width=3000, height=2000, res=800, units="px")
...
png(file = "boxplot_ML1E_gaussian.png", bg = "transparent",width=3000, height=2000, res=800, units="px")
...
png(file = "boxplot_ML_inf_gaussian.png", bg = "transparent",width=3000, height=2000, res=800, units="px")
boxplot_ML_infE_gaussian
dev.off()

boxplot(t(ML_infE3_umd))
boxplot(t(ML_infE3_kde2d))
save.image("20240528_gaussian_seed.RData")